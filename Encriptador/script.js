    ...
    let msj; //container for resulted message
    let copyText; // flag for copy
    let encrypted=false; //flag to review empty textarea
    let invalid_text; //flag to verify if entry is allowed
